            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                  BoxShadow(color: Colors.black,offset: Offset(1, 1),blurRadius: 5,spreadRadius: 1)
                  ]
                ),
                child: Image.asset("images/pizza.jpeg",height: 280,width: 300,fit: BoxFit.cover),
              ),
              Container(
                padding: EdgeInsets.all(10),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){
                       Provider.of<PurchaseCount>(context, listen: false).incrementCount();
                    },
